...
export default function UpdatePortfolioCategory() {
    ...
    const fetchMenuItem = async () => {
        try {
            const response = await axios.get(`${process.env.REACT_APP_API_URL}/api/portfolio_categories/view/${category_name}`);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await axios.patch(`${process.env.REACT_APP_API_URL}/api/portfolio_categories/update/${category._id}`, {
