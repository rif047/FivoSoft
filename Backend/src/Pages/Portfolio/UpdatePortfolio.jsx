...
export default function CreatePortfolio() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            const response = await axios.get(`${process.env.REACT_APP_API_URL}/api/portfolios/view/${name}`);
        ...
        let fetchCategories = async () => {
            const response = await axios.get(`${process.env.REACT_APP_API_URL}/api/portfolio_categories`);
    ...
    const submit = async (e) => {
        ...
        try {
            ...
            await axios.patch(`${process.env.REACT_APP_API_URL}/api/portfolios/update/${portfolio._id}`, formData);
            ...
            <div className="max-w-[700px] px-2 mx-auto">
                ...
                <form className="form" onSubmit={submit} encType="multipart/form-data">
                    ...
                    <div className="mb-4">
                        ...
                        {image ? (
                            <img
                                src={imageUrl || `${process.env.REACT_APP_API_URL}/Images/Portfolio/${image}`}
                                alt={name}
