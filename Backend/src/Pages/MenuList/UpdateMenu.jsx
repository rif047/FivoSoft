...
export default function UpdateMenu() {
    ...
    const fetchMenuItem = async () => {
        try {
            const response = await axios.get(`${process.env.REACT_APP_API_URL}/api/menu_items/view/${menu_name}`);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await axios.patch(`${process.env.REACT_APP_API_URL}/api/menu_items/update/${menu._id}`, {
                menu_name: menuName,
                url: url
            });
