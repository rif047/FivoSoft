...
function Login() {
    ...
    const handleLogin = async (event) => {
        ...
        try {
            const response = await axios.post(`${process.env.REACT_APP_API_URL}/api/auth`, { username, password });
                        ...
                        <div className="divide-y divide-gray-200">
                            <form onSubmit={handleLogin} className="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
                                <div className="relative">
                                    <input name="username" type="text" className="mt-1 mb-2 peer placeholder-transparent h-10 w-full border-b-2 border-gray-300 text-gray-900 focus:outline-none focus:borer-rose-600" placeholder="Username" value={username} onChange={(e) => setUsername(e.target.value)} />
